...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3718461446ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pahinungod&table=judge_3">`pahinungod`.`judge_3`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pahinungod&table=judge_2">`pahinungod`.`judge_2`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pahinungod&table=judge_1">`pahinungod`.`judge_1`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pahinungod&table=combined_scores">`pahinungod`.`combined_scores`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pahinungod&table=results">`pahinungod`.`results`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=grouponili&table=tbl_propose">`grouponili`.`tbl_propose`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=grouponili&table=tbl_admin">`grouponili`.`tbl_admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=web_dev_proposal&table=events">`web_dev_proposal`.`events`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=web_dev_proposal&table=admin_tbl">`web_dev_proposal`.`admin_tbl`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbm_students&table=students">`dbm_students`.`students`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6d60587c4a5e68213e666e5741273579">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="pahinungod" targettable="judge_1">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `judge_1`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pahinungod" targettable="judge_2">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `judge_2`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pahinungod" targettable="judge_3">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `judge_3`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pahinungod" targettable="judge_1">
                            <div class="action_content">
